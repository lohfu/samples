...
var _chainFunction2 = _interopRequireDefault(index$1);
...
var _propTypes2 = _interopRequireDefault(index$3);
...
var index_1 = index$5.batchActions;
var index_2 = index$5.enableBatching;
...
function transition(className, options, complete) {
  ...
  return {
    start: function start(next, hooks) {
...
function animate(element, className, options) {
  ...
  (_element$classList = element.classList).add.apply(_element$classList, _toConsumableArray(className.split(' ')).concat(['animate']));
  ...
  var timeout = setTimeout(function () {
    ...
    var duration = parseFloat(window.getComputedStyle(element).getPropertyValue('transition-duration'));

    timeout = setTimeout(function () {
      // finish animation if we are still waiting for transitionend
      if (element.matches('.animate.active')) dequeue(element);
  ...
  return function () {
    ...
    (_element$classList2 = element.classList).remove.apply(_element$classList2, _toConsumableArray(className.split(' ')));
  };
}

function enter(element, targetElement, options, complete) {
  options = options || {};

  var animation = transition('enter', options, complete);

  queue(element, function () {
    ...
    if (options.animateHeight) element.style.height = element.scrollHeight;

    animation.start.apply(element, arguments);
  });

  queue(element, animation.finish);
}

function leave(element, options, complete) {
  var animation = transition('leave', options, complete || function () {
  ...
  if (options && options.animateHeight && !element.classList.contains('animate')) {
    queue(element, function (next, hooks) {
  ...
  queue(element, animation.start);
  queue(element, animation.finish);
}



function show(element, options, complete) {
  if (element.classList.contains('visible')) return;

  finish(element);

  queue(element, function (next) {
    element.classList.add('visible');

    next();
  });

  enter(element, null, options, complete);
}

function hide(element, options, complete) {
...
var AnimateHOC = (function (Component) {
  return function (_React$Component) {
    inherits(AnimateHOC, _React$Component);

    function AnimateHOC() {
      classCallCheck(this, AnimateHOC);
      return possibleConstructorReturn(this, (AnimateHOC.__proto__ || Object.getPrototypeOf(AnimateHOC)).apply(this, arguments));
    }

    createClass(AnimateHOC, [{
...
var Index = function Index(_ref) {
  ...
  return React.createElement(
    'section',
    { className: 'page' },
    React.createElement('div', { className: 'container', dangerouslySetInnerHTML: { __html: regions.main } })
  );
};

var Index$1 = AnimateHOC(reactRedux.connect(function (state) {
...
var ServiceList = function ServiceList(_ref) {
  ...
  return React.createElement(
    'section',
    { className: 'services list collection container' },
    React.createElement(
      'h1',
      null,
      'Services'
    ...
    services && services.map(function (service) {
      return React.createElement(
        ...
        React.createElement('div', { dangerouslySetInnerHTML: { __html: service.description } })
      );
    })
  );
};

var ServiceList$1 = reactRedux.connect(function (state) {
...
var About = function About(_ref) {
  ...
  return React.createElement(
    'section',
    { className: 'page row' },
    React.createElement('div', { className: 'left cell', dangerouslySetInnerHTML: { __html: regions.main } }),
    React.createElement(
      'div',
      { className: 'right cell' },
      React.createElement(ServiceList$1, null)
    )
  );
};

var About$1 = AnimateHOC(reactRedux.connect(function (state) {
  return { regions: state.regions };
})(About));
...
var EmployeeList = function EmployeeList(_ref) {
  ...
  return React.createElement(
    'section',
    { className: 'employees list collection container' },
    React.createElement(
      'h1',
      null,
      'Employees'
    ...
    employees && employees.map(function (employee) {
      return React.createElement(
        ...
        React.createElement('div', { dangerouslySetInnerHTML: { __html: employee.description } })
      );
    })
  );
};

var EmployeeList$1 = reactRedux.connect(function (state) {
...
var Contact = function Contact(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      'div',
      { className: 'right cell' },
      React.createElement(EmployeeList$1, null)
    )
  );
};

var Contact$1 = AnimateHOC(reactRedux.connect(function (state) {
  return { regions: state.regions };
})(Contact));
...
function changePage(path) {
  ...
  Object.entries(state).forEach(function (_ref) {
    ...
    actions.push(set$$1(key, payload));
    keys.push(key);
  });

  // add remove action for all currentKeys that are not in keys
  currentKeys.filter(function (key) {
  ...
  return index_1(actions);
}

var Navigation = function Navigation(_ref) {
  var changePage$$1 = _ref.changePage;
  return React.createElement(
    'nav',
    null,
    React.createElement(
...
var Navigation$1 = reactRedux.connect(null, function (dispatch) {
  return {
    changePage: function changePage$$1(path) {
  ...
  createClass(App, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        { id: 'app' },
        React.createElement(Navigation$1, null),
        React.createElement(
          TransitionGroup,
          { component: 'main' },
          location && location.component && React.createElement(location.component, { key: location.name }),
          location && location.component && React.createElement(location.component, { key: location.name + 'penis' })
        )
      );
    }
  }]);
...
var App$1 = reactRedux.connect(function (state) {
...
var loggerMiddleware = unwrapExports(reduxLogger);
...
var store = redux.createStore(index_2(rootReducer), redux.applyMiddleware(loggerMiddleware));
